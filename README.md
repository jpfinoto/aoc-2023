...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `39.4µs` | `850.9µs` |
| [Day 2](./src/bin/02.rs) | `363.9µs` | `357.7µs` |
| [Day 3](./src/bin/03.rs) | `14.4ms` | `13.5ms` |
| [Day 4](./src/bin/04.rs) | `883.7µs` | `889.4µs` |
| [Day 5](./src/bin/05.rs) | `40.2µs` | `84.0µs` |
