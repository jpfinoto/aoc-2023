...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `40.2µs` | `845.5µs` |
| [Day 2](./src/bin/02.rs) | `356.2µs` | `356.6µs` |
| [Day 3](./src/bin/03.rs) | `13.6ms` | `13.5ms` |
| [Day 4](./src/bin/04.rs) | `895.5µs` | `916.7µs` |
| [Day 5](./src/bin/05.rs) | `39.3µs` | `82.9µs` |
